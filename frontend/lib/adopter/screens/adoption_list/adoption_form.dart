...
class _AdoptionFormState extends State<AdoptionForm> {
                    ...
                    _buildBox(
                      Column(
                        ...
                        children: [
                          ...
                          _buildTextFormField(
                              'Email Address', (value) => _email = value),
                          _buildTextFormField(
  ...
  Widget _buildDropdownFormField(String label, List<String> options,
  ...
  void _submitAdoptionForm(BuildContext context) {
