...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) => ChatBloc(context.read<AdopterChatRepository>())
          ..add(FetchMessages(widget.chatId)), // Fetch messages for this chatId
        child: BlocBuilder<ChatBloc, ChatMessageState>(
                      ...
                      children: [
                        Expanded(
                          child: TextField(
                            ...
                            onSubmitted: (text) {
                              if (text.isNotEmpty) {
                                context.read<ChatBloc>().add(SendMessage(text, widget.userName)); // Send message
